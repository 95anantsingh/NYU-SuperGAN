...
def main(in_dir, out_dir=None, indices=None, detection_model_path='weights/WIDERFace_DSFD_RES152.pth', batch_size=8,
    ...
    for r, d, f in os.walk(in_dir):
        for file in f:
            if '.mp4' in file:
                vid_paths.append(os.path.join(r, file))
    ...
    for i, vid_path in enumerate(vid_paths):
        ...
        curr_cache_path = os.path.join(os.path.split(vid_path)[0], vid_name + out_postfix)
...
if __name__ == "__main__":
    ...
    import argparse
    parser = argparse.ArgumentParser('cache_video_batch_recursive')
